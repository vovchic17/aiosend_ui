...
type DeleteAllInvoicesCodeProps = {
  isRunning: boolean;
  canRun: boolean;
...
export function DeleteAllInvoicesCode({
  isRunning,
  canRun,
  output,
  copy,
    ...
    <div data-smart-animate="code-window" className="relative overflow-hidden rounded-[10px] border border-subtle-border bg-code-surface">
      ...
      <div className="overflow-x-auto px-5 py-5 pr-14">
        <div className="min-w-[480px] space-y-1">
          ...
          <CodeLine number={4}>
            <span>cp.</span>
            <span className="text-syntax-built-in">delete_all_invoices</span>
            <span>()</span>
          </CodeLine>
        </div>
      </div>
